...
## the AI assistant-Specific Integration Points

| Feature | Endpoint | the AI assistant Usage |
|---------|----------|------------|
...
| **Service Health** | `/admin/serviceAnnouncement/healthOverviews` | the AI assistant-aware service status |
