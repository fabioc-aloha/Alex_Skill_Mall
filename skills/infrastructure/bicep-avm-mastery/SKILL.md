...
the AI assistant → mcp_bicep_list_avm_metadata 
  Filter: storage
...
the AI assistant → mcp_bicep_get_az_resource_type_schema
...
the AI assistant → mcp_bicep_get_bicep_file_diagnostics
  filePath: main.bicep
...
the AI assistant → mcp_bicep_decompile_arm_template_file
