...
function renderStorefrontReadme(stores, index, auditJson) {
  ...
  lines.push('| --- | --- | --- | --- |');
  lines.push('| Give Copilot a reliable baseline across projects | [`alex-act-core`](https://github.com/fabioc-aloha/Alex_ACT_Core/tree/v4.0.0) | `4.0.0` | Critical thinking, planning, security and privacy guidance, project bootstrap, and plugin management |');
  lines.push('| Create charts, print figures, banners, AI images, or browsable documentation | [`alex-act-illustrator-plugin`](https://github.com/fabioc-aloha/Alex_ACT_Illustrator_Plugin/tree/v2.4.0) | `2.4.0` | Visual framing, authoring, generation, and verification workflows |');
