...
function renderStorefrontReadme(stores, index, auditJson) {
  ...
  lines.push('');
  lines.push('Six packages preceded Alex ACT ONE: `alex-act-core`, `alex-act-illustrator-plugin`, `alex-act-document-tools`, `alex-act-document-tools-portable`, `alex-act-enterprise`, and `alex-act-ai-operations`. They remain in the catalog for existing installations and migration guidance. `alex-act-core`, `alex-act-illustrator-plugin`, `alex-act-document-tools`, `alex-act-document-tools-portable`, and `alex-act-enterprise` are withdrawn for new installations. `alex-act-ai-operations` remains available under its independent lifecycle. Install Alex ACT ONE instead.');
  lines.push('');
