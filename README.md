...
The Mall publishes **360 curated plugins** for direct installation and maintains a **trust-scored discovery index** across **4059 plugins** in **48 stores**.
...
| ---: | --- | ---: | ---: | --- |
| 1 | 🏆 [plugin-mall](catalog/stores/plugin-mall.md) | 82 | 360 | 🏆 first-party |
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-08-17T11:07:42.765Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
