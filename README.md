...
The Mall publishes **363 curated plugins** for direct installation and maintains a **trust-scored discovery index** across **3866 plugins** in **42 stores**.
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-08-03T12:06:24.435Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
