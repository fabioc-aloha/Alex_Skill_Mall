...
**365 curated plugins**, installable as a GitHub Copilot CLI marketplace. Plus a **trust-scored discovery index** across **3766 plugins** in **36 stores** so you can find and install directly from upstream at a version you pick.
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-07-29T00:51:45.361Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
