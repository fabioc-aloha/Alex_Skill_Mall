...
**365 curated plugins**, installable as a GitHub Copilot CLI marketplace. Plus a **trust-scored discovery index** across **3479 plugins** in **29 stores** so you can find and install directly from upstream at a version you pick.
...
| 3 | [antigravity-awesome-skills](catalog/stores/antigravity-awesome-skills.md) | 35 | 1904 | third-party |
| 4 | [awesome-copilot](catalog/stores/awesome-copilot.md) | 35 | 485 | third-party |
...
| 9 | [marketingskills](catalog/stores/marketingskills.md) | 35 | 50 | third-party |
| 10 | [planning-with-files](catalog/stores/planning-with-files.md) | 35 | 6 | third-party |
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-07-29T00:23:34.118Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
