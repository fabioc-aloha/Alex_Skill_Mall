...
The Mall publishes **362 curated plugins** for direct installation and maintains a **trust-scored discovery index** across **4046 plugins** in **48 stores**.
...
| 4 | [awesome-copilot](catalog/stores/awesome-copilot.md) | 35 | 500 | third-party |
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-08-15T20:43:06.794Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
