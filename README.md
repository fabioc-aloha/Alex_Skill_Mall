...
The Mall publishes **360 curated plugins** for direct installation and maintains a **trust-scored discovery index** across **4,267 plugins** in **53 stores**.
...
```text
Evaluate <plugin-name> from the Alex Mall before I install it.
```
...
---
*Generated by `scripts/render-catalog.cjs` at 2026-09-14T00:37:44.646Z. Source of truth: `catalog/*.json`. Never hand-edit this README.*
