---
description: 'Plans and executes multi-file changes by mapping context, tracing dependencies, and sequencing modifications'
tools: ['codebase', 'search', 'usages', 'problems', 'readFile', 'editFiles', 'runInTerminal', 'getTerminalOutput', 'fetch']
