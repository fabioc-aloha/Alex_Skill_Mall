...
and efficiency signals. Its compiler produces reviewable, optimized drafts from
...
Markdown-only inventory, local-link diagnostics, component-path diagnostics,
and output-path rejection.
