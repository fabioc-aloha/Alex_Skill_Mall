...
Revisit by **2026-11-04** if the command cannot preserve the brain spine, if its preview and apply behavior diverge, or if users mistake repository defaults for VS Code's separately stored runtime state.
