---
description: "Routes legacy Core setup requests to Manager's canonical constellation install and repair workflow. Use when an older caller invokes Core's compatibility command."
lastReviewed: 2026-08-04
---

# /install-constellation

This is a compatibility command. Manager owns constellation lifecycle. Route the user to
