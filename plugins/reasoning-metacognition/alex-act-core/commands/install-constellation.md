...
10. Point at namespaced next steps: `/alex-act-enterprise setup-enterprise`, `/alex-act-msft setup-msft`, `/alex-act-core bootstrap-workspace`, and `/alex-act-illustrator-plugin install-visual-companions` when applicable.
