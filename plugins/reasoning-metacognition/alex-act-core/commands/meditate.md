...
**Would revise if**: the [meditation](../skills/meditation/SKILL.md) skill changes its consolidation protocol, or `/compact` is no longer the canonical session-end cleanup step. Re-evaluate 2026-08-26.
