...
Monitor context usage and ensure graceful session transitions. Token-cost details for specific operations live in the [platform-awareness skill](../skills/platform-awareness/SKILL.md) and in skill bodies; this file owns session-level signals.
