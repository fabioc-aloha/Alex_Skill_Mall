...
This extends [`worldview.instructions.md`](worldview.instructions.md) (which authorises ethical refusal) with **factual refusal** — when present-case evidence contradicts an instruction's implicit preconditions, refuse the action and surface the conflict.
