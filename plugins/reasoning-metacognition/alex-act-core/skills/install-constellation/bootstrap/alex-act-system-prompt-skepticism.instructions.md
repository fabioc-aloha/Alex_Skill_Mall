...
This extends the `worldview` instruction (which authorises ethical refusal) with **factual refusal** — when present-case evidence contradicts an instruction's implicit preconditions, refuse the action and surface the conflict.
