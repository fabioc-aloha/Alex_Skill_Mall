...
- Disabled VS Code's automatic next-change reveal in the portable user baseline
...
- `USER-EXPERIENCE.md` § Stage 1 — rewrites Stage 1 as the 4-step install flow
- `USER-EXPERIENCE.md` § Stage 6 — Remove the constellation (uninstall walkthrough)
- `PLUGIN-INTEGRATION.md` § 3 — greeting-checkin discovery pattern under the update model
...
Content grounded in Steward's `constellation/PLUGIN-INTEGRATION.md` (adopted 2026-07-30) — the constellation's canonical source for pull-at-install distribution model, user-vs-repo scope split, and manual update workflow.
