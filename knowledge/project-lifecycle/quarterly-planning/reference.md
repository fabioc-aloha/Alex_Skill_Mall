# quarterly-planning Reference

20 PM planning skills: scenario creation, cost analysis, capacity modeling, work breakdown, cut-line decisions, ranking guidance. Consult during quarterly planning cycles.

This is a **knowledge package** -- consult on demand, not loaded into the brain.
Source plugin: `devops-process\pm-planning-suite`
